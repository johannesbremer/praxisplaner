  ...
  return (
    ...
    >
      ...
      <EmojiPickerPrimitive.Search
        className="outline-hidden placeholder:text-foreground/35 flex h-10 w-full rounded-md bg-transparent py-3 text-sm disabled:cursor-not-allowed disabled:opacity-50"
