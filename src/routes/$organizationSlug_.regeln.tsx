    ...
    <div className="container mx-auto p-6">
      ...
      {currentWorkingRuleSet && isShowingUnsavedRuleSet && (
        <div className="sticky top-3 z-40 mb-6">
          <div className="mx-auto flex w-full max-w-6xl flex-col gap-4 rounded-md border border-destructive/40 bg-destructive/10 px-4 py-3 text-destructive dark:border-destructive/70 dark:bg-destructive/60 dark:text-white">
