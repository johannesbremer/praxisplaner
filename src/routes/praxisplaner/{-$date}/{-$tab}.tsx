...
// Utility functions for date and tab parameter handling
...
function PraxisPlanerComponent() {
  ...
  // Tab management state - now driven by URL
  ...
  // Function to update URL when tab or date changes
  const updateUrl = useCallback(
    (newTab?: string, newDate?: Date) => {
      ...
      const params: { date?: string; tab?: string } = {};
      if (dateParam) {
  ...
  const openPatientTab = useCallback(
    ...
    [patientTabs, addGdtLog, setActiveTab],
  );
  ...
  const closePatientTab = useCallback(
    ...
    [activeTab, addGdtLog, setActiveTab],
  );
